...
def solve_http_request_question(question, file=None):
    try:
        ...
        params = {"email": "23f1001231@ds.study.iitm.ac.in"}
...
def solve_count_wednesdays_question(question, file=None):
    ...
    try:
        ...
        start_date = datetime.strptime(match.group(1), "kY-%m-%d")
...
def solve_github_repo_question(question, file=None):
    return {"answer": "https://raw.githubusercontent.com/10622537/test/refs/heads/main/email.json"}
...
def solve_github_pages_question(question, file=None):
    return {"answer": "https://23f1001231.github.io/testsite/"}
...
def solve_github_action_question(question, file=None):
    return {"answer": "https://github.com/23f1001231/test-actions"}

# Function GA2Q8: Docker image
def solve_docker_image_question(question, file=None):
    return {"answer": "https://hub.docker.com/repository/docker/23f1001231/py-hello/general"}
...
def solve_scheduled_github_action(question, file=None):
    return {"answer": "https://github.com/23f1001231/tds-auto-commit"}
