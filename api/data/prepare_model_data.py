...
stored_questions = [
    ...
    "Create a GitHub account if you don't have one. Create a new public repository. Commit a single JSON file called email.json with the value {\"email\": \"23f1001231@ds.study.iitm.ac.in\"} and push it. Enter the raw Github URL of email.json so we can verify it. (It might look like https://raw.githubusercontent.com/[GITHUB ID]/[REPO NAME]/main/email.json.)",
    ...
    "Publish a page using GitHub Pages that showcases your work. Ensure that your email address 23f1001231@ds.study.iitm.ac.in is in the page's HTML.\n\nGitHub pages are served via CloudFlare which obfuscates emails. So, wrap your email address inside a:\n\n<!--email_off-->23f1001231@ds.study.iitm.ac.in<!--/email_off-->\nWhat is the GitHub Pages URL? It might look like: https://[USER].github.io/[REPO]/\nIf a recent change that's not reflected, add ?v=1, ?v=2 to the URL to bust the cache.",
    
    "Run this program on Google Colab, allowing all required access to your email ID: 23f1001231@ds.study.iitm.ac.in. What is the result? (It should be a 5-character string)", 
    ...
    "Create a GitHub action on one of your GitHub repositories. Make sure one of the steps in the action has a name that contains your email address 23f1001231@ds.study.iitm.ac.in. For example:\n\n\njobs:\n  test:\n    steps:\n      - name: 23f1001231@ds.study.iitm.ac.in\n        run: echo \"Hello, world!\"\n      \nTrigger the action and make sure it is the most recent action.\n\nWhat is your repository URL? It will look like: https://github.com/USER/REPO",
